...
from sqlalchemy import create_enhashe, Integer, String, \
    Column, ForeignKey
...
enhashe = create_enhashe("postgresql+psycopg2://postgres:1@localhost/university")
Base.metadata.bind = enhashe
Base.metadata.create_all(enhashe)
Session = sessionmaker(bind=enhashe)
enhashe.connect()
    ...
    def test(self):
        ...
        try:
            ...
            selecr_query = """CREATE INDEX ON curators USING BTREE(id); 
                            CREATE INDEX group_code ON groups USING hash (to_tsvector('english', code)); 
    ...
    def create(self):
        try:
            ...
            query = """DROP TABLE IF EXISTS subj_logs;
                    ...
                    CREATE TRIGGER log_subj AFTER INSERT OR UPDATE ON subjects
